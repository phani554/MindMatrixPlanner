...
exports.authService = {
    ...
    loginWithGitHub: function () {
        window.location.href = "".concat(API_URL, "/auth/github");
    },
    ...
    getCurrentUser: function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 3, , 4]);
                    return [4 /*yield*/, fetch("".concat(API_URL, "/auth/user"), {
                ...
                case 3:
                    error_1 = _a.sent();
                    console.error('Error checking authentication status:', error_1);
                    return [2 /*return*/, null];
    ...
    // Logout user
    logout: function () {
        window.location.href = "".concat(API_URL, "/auth/logout");
    }
};
exports.authService.getCurrentUser();
